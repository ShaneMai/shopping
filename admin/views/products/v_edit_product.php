            ...
            <div class="col-md-6">
                <div class="card">
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <h4 class="card-title">Sửa sản phẩm sản phẩm</h4>
                            <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Tên sản
                                    phẩm</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fname" placeholder="Nhập tên sản phẩm"
                                           name="ten_san_pham" value="<?php echo $product_detail->ten_san_pham;?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="custom-file">
                                        ...
                                        <?php if ($product_detail->hinh!=""){?>
                                            <img src="../public/img/product/<?php echo $product_detail->hinh;?>" width="100px" />
                                        <?php }?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="mo_ta_tom_tat"
                                           ...
                                           name="mo_ta_tom_tat" value="<?php echo $product_detail->mo_ta_tom_tat;?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Thông tin
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="mo_ta_chi_tiet"
                                           ...
                                           name="mo_ta_chi_tiet" value="<?php echo $product_detail->mo_ta_chi_tiet;?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="don_gia" placeholder="Nhập đơn giá"
                                           name="don_gia" value="<?php echo $product_detail->don_gia;?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Ngày
                                    tạo</label>
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="ngay_tao" name="ngay_tao" value="<?php echo $product_detail->ngay_tao;?>">
                                </div>
                            </div>
                        </div>
                        <div class="border-top">
                            <div class="card-body">
                                <button type="submit" id="btn-submit" name="btn-submit" class="btn btn-primary">Cập nhật</button>
                                <button type="button" id="btn-cancell" name="btn-cancell" class="btn btn-primary" onclick="window.location='products.php'">Bỏ qua</button>
                            </div>
                        </div>
                    </form>
                </div>
